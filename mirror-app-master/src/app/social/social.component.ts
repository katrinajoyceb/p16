  ...
  drawSketch(){
    ...
    this.sketch = (s) => {
      ...
      s.setup = () => {
        ...
        img1 = s.createImg('../../assets/bot.png', "").parent('social-canvas');
        img1.position(35, 80);

        s.rect(20, 180, 360, 100, 15); //tweet 2
        img2 = s.createImg('../../assets/cheeto.png', "").parent('social-canvas');
        ...
        s.textSize(18);
        s.text('Beep boop I am a robot', 110, 100, 250, 80); // social message 1
        s.text('Despite the constant negative press covfefe', 110, 220, 250, 80); // social message 2

        s.textStyle(s.BOLD);
        s.textSize(20);
        s.text('Twitter Bot', 110, 90); // social sender 1
        s.text('Donald J. Trump', 110, 210); // social sender 2
